...
class autobots(object):
    ...
    def __init__(self):
        self.rname = livejson.File('data/key.json', True, False, 4)["rname"]
        if self.rname != "":
    ...
    def ERROR(self,data):
        result = {"type": "bubble", "size": "micro", "body": {"type": "box", "layout": "vertical", "contents": [{"type": "text", "text": "ERROR!!", "color": "#ffffffcc", "weight": "bold"}, {"type": "text", "text": f"{data}", "color": "#ffffffcc", "size": "xxs", "wrap": True } ], "backgroundColor": "#e00000"} }
        if data == "ERROR" or data == "Not found":
           if data != "Not found.":
              data = data+"!!"
           result = {"type": "bubble", "size": "nano", "body": {"type": "box", "layout": "vertical", "contents": [{"type": "text", "text": f"{data.replace('.','').upper()}", "color": "#ffffffcc", "weight": "bold"}, ], "backgroundColor": "#e00000"} }
        return result
