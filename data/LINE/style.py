...
# TEMPLATE BY : THE AUTOBOTS CORPORATION | RENDYTR

class autobots(object):

    def __init__(self):
        self.branding    = "IMJUSTGOOD"
        self.badge       = "https://i.ibb.co/XZ90vcP/justgood.png"
        self.brandingURL = "https://api.imjustgood.com/custom/tools"
        print(f"{self.branding} STARTED UP !\n")

    def ERROR(self,data):
        result = {"type": "bubble", "size": "micro", "body": {"type": "box", "layout": "vertical", "contents": [{"type": "text", "text": "ERROR!!", "color": "#ffffffcc", "size": "sm", "weight": "bold"}, {"type": "text", "text": f"{data}", "color": "#ffffffcc", "size": "xxs", "wrap": True } ], "backgroundColor": "#e00000"} }
        if data in ["ERROR", "Not found"]:
            if data != "Not found.":data = data + "!!"
            result = {"type": "bubble", "size": "nano", "body": {"type": "box", "layout": "vertical", "contents": [{"type": "text", "text": f"{data.replace('.','').upper()}", "color": "#ffffffcc", "size": "sm", "weight": "bold"}, ], "backgroundColor": "#e00000"} }
        return result

    def help(self):
        data   = ['https://i.ibb.co/TRh8X8X/menu-1.jpg', 'https://i.ibb.co/P63WSbx/menu-2.jpg', 'https://i.ibb.co/MMTVRLM/menu-3.jpg', 'https://i.ibb.co/JyRWzv6/menu-4.jpg', 'https://i.ibb.co/R901D90/menu-5.jpg', 'https://i.ibb.co/D7fW7w2/menu-6.jpg']
        bubble = [{"type": "bubble", "size": "kilo", "body": {"type": "box", "layout": "vertical", "contents": [{"type": "box", "layout": "vertical", "contents": [{"type": "image", "url": "https://i.ibb.co/4WQ2XLc/homepage.jpg", "aspectRatio": "2:3", "aspectMode": "cover", "size": "full"} ] }, {"type": "box", "layout": "vertical", "contents": [], "position": "absolute", "width": "120px", "height": "35px", "offsetStart": "69px", "offsetTop": "189px", "action": {"type": "uri", "uri": "https://api.imjustgood.com/apidoc"} }, {"type": "box", "layout": "vertical", "contents": [], "position": "absolute", "width": "120px", "height": "35px", "offsetStart": "69px", "offsetTop": "232px", "action": {"type": "uri", "uri": "https://pypi.org/project/justgood"} }, {"type": "box", "layout": "vertical", "contents": [], "position": "absolute", "width": "120px", "height": "35px", "offsetStart": "69px", "offsetTop": "274px", "action": {"type": "uri", "uri": "https://api.imjustgood.com/custom/tools"} } ], "paddingAll": "0px"} }]
        for x in data:
            flexdata = {"type": "bubble", "size": "kilo", "body": {"type": "box", "layout": "vertical", "contents": [{"type": "box", "layout": "vertical", "contents": [{"type": "image", "url": x, "aspectRatio": "2:3", "aspectMode": "cover", "size": "full"} ] }, {"type": "box", "layout": "vertical", "contents": [], "position": "absolute", "width": "240px", "height": "35px", "action": {"type": "uri", "uri": "https://imjustgood.com/team"}, "offsetBottom": "15px", "offsetStart": "10px"} ], "paddingAll": "0px"} }
            bubble.append(flexdata)
        result = {"type": "carousel", "contents": bubble}
        return result
